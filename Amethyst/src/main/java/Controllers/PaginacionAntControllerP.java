 ...
 * @author denis
 */
@WebServlet(name = "PaginacionAntControllerP", urlPatterns = {"/PaginacionAntControllerP"})
public class PaginacionAntControllerP extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(Integer.parseInt(section)==1){    
            try { 
                ...
                Logger.getLogger(PaginacionAntControllerP.class.getName()).log(Level.SEVERE, null, ex);
            }
