 ...
 * @author denis
 */
@WebServlet(name = "DeleteMeGustaController", urlPatterns = {"/DeleteMeGustaController"})
public class DeleteMeGustaController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DeleteMeGustaController</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DeleteMeGustaController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        //processRequest(request, response);
        String idLike = request.getParameter("input-idLike");
        String page = request.getParameter("pageMG");
        String section = request.getParameter("sectionMG");
        ...
        if(Integer.parseInt(section)==1){
            try {
                boolean result = mDAO.delete(Integer.parseInt(idLike));
                ...
                Logger.getLogger(DeleteMeGustaController.class.getName()).log(Level.SEVERE, null, ex);
            }
