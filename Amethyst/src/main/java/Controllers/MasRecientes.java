 ...
 * @author denis
 */
@WebServlet(name = "MasRecientes", urlPatterns = {"/MasRecientes"})
public class MasRecientes extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(MasRecientes.class.getName()).log(Level.SEVERE, null, ex);
        }
