 ...
 * @author denis
 */
@WebServlet(name = "BusquedaBasicaP", urlPatterns = {"/BusquedaBasicaP"})
public class BusquedaBasicaP extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet BusquedaBasica</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet BusquedaBasica at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
       // processRequest(request, response);
       String texto = request.getParameter("input-search");
        ...
        try {
            ...
            Logger.getLogger(BusquedaBasicaP.class.getName()).log(Level.SEVERE, null, ex);
        }
