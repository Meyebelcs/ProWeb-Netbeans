 ...
 * @author denis
 */
@WebServlet(name = "PaginacionDespController", urlPatterns = {"/PaginacionDespController"})
public class PaginacionDespController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(Integer.parseInt(section)==1){
            try {
                ...
                Logger.getLogger(PaginacionDespController.class.getName()).log(Level.SEVERE, null, ex);
            }
