 ...
 * @author denis
 */
@WebServlet(name = "DeletePublicationController", urlPatterns = {"/DeletePublicationController"})
public class DeletePublicationController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DeletePublicationController</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DeletePublicationController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
       // processRequest(request, response);
       String idPublicacion = request.getParameter("idPubliDP");
        String page = request.getParameter("pageDP");
        String section = request.getParameter("sectionDP");
       ...
       PublicacionDAO pDAO = new PublicacionDAO();
        ...
        if(Integer.parseInt(section)==1){
            try {
                boolean result = pDAO.delete(Integer.parseInt(idPublicacion));
                ...
                Logger.getLogger(DeletePublicationController.class.getName()).log(Level.SEVERE, null, ex);
            }
